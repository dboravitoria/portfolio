import { FaGithub, FaLinkedin, FaInstagramSquare, FaMapMarkerAlt, FaPhoneSquareAlt,BsEnvelopeAtFill   } from "../../utils/icons";
...
export default function Footer(){
    ...
    return(
        <>
            <footer className="border-t p-2 border-secondaryDark/15 drop-shadow-custom backdrop-blur-md shadow-custom text-secondaryDark dark:text-white w-full  py-2 z-50 dark:border-white/15 transition  dark:bg-white/10 bg-secondaryDark/10 flex flex-col justify-end fixed bottom-0 items-center sm:mt-14">
