export default function Input({ type, title, placeholder }) {
  ...
  return isTextarea ? (
    <textarea name={title} id={title} placeholder={placeholder} className={textareaClasses}/>
  ) : (
    <input type={type} name={title} id={title} placeholder={placeholder} className={inputClasses}/>
  );
}
